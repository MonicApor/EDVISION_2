           			...
           			<div class="col-md-6">
                		<div class="panel">
                            ...
                            <div class="panel-footer bg-gray-light">
                                ...
                                <button type="button" onClick="Updateclassroom(this)" id="btnSubmit1" class="btn btn-success" style="width: 100%;"><span class="glyphicon glyphicon-ok-sign"></span>Update</button>
                            </div><!--/.panel-footer-->
            			</div><!--/.panel-->
            		</div><!--/.col-md-6-->
            	</div><!--/.row-->
